...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name, ['package.xml']),
         ('share/'+package_name +'/resource',['resource/moon.wav']),
          ('share/'+package_name +'/resource',['resource/gaga1.wav']),
           ('share/'+package_name +'/resource',['resource/gaga2.wav']),
            ('share/'+package_name +'/resource',['resource/gaga3.wav']),
             ('share/'+package_name +'/resource',['resource/gaga4.wav']),
    ],
