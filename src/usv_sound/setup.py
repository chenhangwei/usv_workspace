...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name, ['package.xml']),
         ('share/'+package_name +'/resource',['resource/moon1.wav']),
          ('share/'+package_name +'/resource',['resource/gaga11.wav']),
           ('share/'+package_name +'/resource',['resource/gaga22.wav']),
            ('share/'+package_name +'/resource',['resource/gaga33.wav']),
             ('share/'+package_name +'/resource',['resource/gaga44.wav']),
    ],
