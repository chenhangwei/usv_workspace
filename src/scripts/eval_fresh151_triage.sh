#!/bin/bash
# One-episode paired triage for fresh151 crossing/random candidates.
...
OUT="${OUT:-/mnt/data/checkpoints/usv_rl/fresh151_eval}"
SUMMARY="${SUMMARY:-$OUT/fresh151_triage_summary.tsv}"
EPISODES="${EPISODES:-1}"
STEPS="${STEPS:-420}"
...
candidates=(
  /mnt/data/checkpoints/usv_rl/fresh151_checkpoints/fresh151_random_safety_gate_from_fresh150_step_0000288.pt
  /mnt/data/checkpoints/usv_rl/fresh151_checkpoints/fresh151_random_safety_gate_from_fresh150_step_0000480.pt
  /mnt/data/checkpoints/usv_rl/fresh151_random_safety_gate_from_fresh150.pt
)
...
print(
    f"fresh151 {label} {scenario_name}: coll={row['collision']:.3f} "
