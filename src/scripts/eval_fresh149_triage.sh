#!/bin/bash
# One-episode paired triage for fresh149 crossing/random candidates.
...
OUT="${OUT:-/mnt/data/checkpoints/usv_rl/fresh149_eval}"
SUMMARY="${SUMMARY:-$OUT/fresh149_triage_summary.tsv}"
EPISODES="${EPISODES:-1}"
STEPS="${STEPS:-420}"
...
candidates=(
  /mnt/data/checkpoints/usv_rl/fresh149_checkpoints/fresh149_anticipatory_turn_soft_clear_from_fresh142_step_0000288.pt
  /mnt/data/checkpoints/usv_rl/fresh149_checkpoints/fresh149_anticipatory_turn_soft_clear_from_fresh142_step_0000480.pt
  /mnt/data/checkpoints/usv_rl/fresh149_anticipatory_turn_soft_clear_from_fresh142.pt
)
...
print(
    f"fresh149 {label} {scenario_name}: coll={row['collision']:.3f} "
