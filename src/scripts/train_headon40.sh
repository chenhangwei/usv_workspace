...
OUTPUT=/mnt/data/checkpoints/usv_rl/headon40.pt
...
python3 -m usv_rl.train_mappo_policy \
  ...
  --head-on-near-miss-distance 1.1 \
  ...
  --anticipation-distance 4.0 \
  --head-on-guidance-distance 4.0 \
  --head-on-target-starboard-offset 0.4 \
