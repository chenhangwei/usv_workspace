...
OUTPUT="${OUTPUT:-/mnt/data/checkpoints/usv_rl/fresh328_native_collision_raw_guard_from_fresh321.pt}"
...
EPOCHS="${EPOCHS:-60}"
LEARNING_RATE="${LEARNING_RATE:-3.0e-7}"
ANCHOR_WEIGHT="${ANCHOR_WEIGHT:-180.0}"
...
for trace in "$TRACE_1461_A" "$TRACE_1461_B" "$TRACE_1461_C" "$TRACE_1458"; do
  if [[ ! -f "$trace" ]]; then
