...
OUTPUT="${OUTPUT:-/mnt/data/checkpoints/usv_rl/fresh520_returnroute_excl.pt}"
CKPT_DIR="${CKPT_DIR:-/mnt/data/checkpoints/usv_rl/fresh520_checkpoints}"
...
echo "[fresh520] WARMSTART_FROM=$WARMSTART_FROM"
echo "[fresh520] OUTPUT=$OUTPUT"
echo "[fresh520] TOTAL_TIMESTEPS=$TOTAL_TIMESTEPS  ROLLOUT_STEPS=$ROLLOUT_STEPS"
echo "[fresh520] BASE_ROS_DOMAIN_ID=$BASE_ROS_DOMAIN_ID"
