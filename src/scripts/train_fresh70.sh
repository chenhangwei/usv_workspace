#!/bin/bash
# fresh70: 修复 3 船密集场景的 omega_flip 暴涨
#
# fresh69 成果 (保留):
...
CKPT_DIR="/mnt/data/checkpoints/usv_rl/fresh70_checkpoints"
# Stage A 复用 fresh68 已训练好的
STAGE_A_OUTPUT="/mnt/data/checkpoints/usv_rl/fresh68_stageA.pt"
STAGE_B_OUTPUT="/mnt/data/checkpoints/usv_rl/fresh70_stageB.pt"
STAGE_C_OUTPUT="/mnt/data/checkpoints/usv_rl/fresh70_stageC.pt"
