...
WARMSTART_FROM="${WARMSTART_FROM:-/mnt/data/checkpoints/usv_rl/fresh509e_collp100_200k.pt}"
OUTPUT="${OUTPUT:-/mnt/data/checkpoints/usv_rl/fresh509g_loosen.pt}"
CKPT_DIR="${CKPT_DIR:-/mnt/data/checkpoints/usv_rl/fresh509g_checkpoints}"
...
BASE_ROS_DOMAIN_ID="${BASE_ROS_DOMAIN_ID:-240}"

echo "[fresh509g] WARMSTART_FROM=$WARMSTART_FROM"
echo "[fresh509g] OUTPUT=$OUTPUT"
echo "[fresh509g] TOTAL_TIMESTEPS=$TOTAL_TIMESTEPS  ROLLOUT_STEPS=$ROLLOUT_STEPS"
echo "[fresh509g] BASE_ROS_DOMAIN_ID=$BASE_ROS_DOMAIN_ID"
