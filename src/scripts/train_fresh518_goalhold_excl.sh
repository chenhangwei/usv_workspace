...
OUTPUT="${OUTPUT:-/mnt/data/checkpoints/usv_rl/fresh518_goalhold_excl.pt}"
CKPT_DIR="${CKPT_DIR:-/mnt/data/checkpoints/usv_rl/fresh518_checkpoints}"
...
BASE_ROS_DOMAIN_ID="${BASE_ROS_DOMAIN_ID:-258}"

echo "[fresh518] WARMSTART_FROM=$WARMSTART_FROM"
echo "[fresh518] OUTPUT=$OUTPUT"
echo "[fresh518] TOTAL_TIMESTEPS=$TOTAL_TIMESTEPS  ROLLOUT_STEPS=$ROLLOUT_STEPS"
echo "[fresh518] BASE_ROS_DOMAIN_ID=$BASE_ROS_DOMAIN_ID"
