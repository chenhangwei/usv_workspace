...
WARMSTART_FROM="${WARMSTART_FROM:-/mnt/data/checkpoints/usv_rl/fresh509a2_criticonly.pt}"
OUTPUT="${OUTPUT:-/mnt/data/checkpoints/usv_rl/fresh509a3_criticonly.pt}"
CKPT_DIR="${CKPT_DIR:-/mnt/data/checkpoints/usv_rl/fresh509a3_checkpoints}"
