#!/bin/bash
# One-episode paired triage for fresh152 random-first repair candidates.
...
OUT="${OUT:-/mnt/data/checkpoints/usv_rl/fresh152_eval}"
SUMMARY="${SUMMARY:-$OUT/fresh152_triage_summary.tsv}"
EPISODES="${EPISODES:-1}"
STEPS="${STEPS:-420}"
...
candidates=(
  /mnt/data/checkpoints/usv_rl/fresh152_checkpoints/fresh152_random_first_safety_brake_from_fresh151_step_0000288.pt
  /mnt/data/checkpoints/usv_rl/fresh152_checkpoints/fresh152_random_first_safety_brake_from_fresh151_step_0000576.pt
  /mnt/data/checkpoints/usv_rl/fresh152_checkpoints/fresh152_random_first_safety_brake_from_fresh151_step_0000720.pt
  /mnt/data/checkpoints/usv_rl/fresh152_random_first_safety_brake_from_fresh151.pt
)
...
print(
    f"fresh152 {label} {scenario_name}: coll={row['collision']:.3f} "
