...
OUTPUT="${OUTPUT:-/mnt/data/checkpoints/usv_rl/fresh515_floortune.pt}"
CKPT_DIR="${CKPT_DIR:-/mnt/data/checkpoints/usv_rl/fresh515_checkpoints}"
...
BASE_ROS_DOMAIN_ID="${BASE_ROS_DOMAIN_ID:-252}"

echo "[fresh515] WARMSTART_FROM=$WARMSTART_FROM"
echo "[fresh515] OUTPUT=$OUTPUT"
echo "[fresh515] TOTAL_TIMESTEPS=$TOTAL_TIMESTEPS  ROLLOUT_STEPS=$ROLLOUT_STEPS"
echo "[fresh515] BASE_ROS_DOMAIN_ID=$BASE_ROS_DOMAIN_ID"
