#!/bin/bash
# One-episode paired triage for fresh157 checkpoints.
...
FINAL_MODEL="${FINAL_MODEL:-/mnt/data/checkpoints/usv_rl/fresh157_role_weighted_guard_from_fresh153.pt}"
SUMMARY="${SUMMARY:-$OUT/fresh157_triage_summary.tsv}"
EPISODES="${EPISODES:-1}"
STEPS="${STEPS:-420}"
...
SEED="${SEED:-1460}"
BASE_DOMAIN="${BASE_DOMAIN:-218}"

mkdir -p "$OUT"
printf 'label\tscenario\tcollision\tsuccess\ttimeout\tprogress\tgoal\tsep\tcte\tentanglement\tcolregs\tomega\tmodel\n' > "$SUMMARY"

candidates=(
  /mnt/data/checkpoints/usv_rl/fresh157_checkpoints/fresh157_role_weighted_guard_from_fresh153_step_0000576.pt
  /mnt/data/checkpoints/usv_rl/fresh157_checkpoints/fresh157_role_weighted_guard_from_fresh153_step_0001152.pt
  /mnt/data/checkpoints/usv_rl/fresh157_checkpoints/fresh157_role_weighted_guard_from_fresh153_step_0001728.pt
  /mnt/data/checkpoints/usv_rl/fresh157_checkpoints/fresh157_role_weighted_guard_from_fresh153_step_0002304.pt
  /mnt/data/checkpoints/usv_rl/fresh157_checkpoints/fresh157_role_weighted_guard_from_fresh153_step_0002880.pt
  "$FINAL_MODEL"
)
...
print(
    f"fresh157-triage {label} {scenario_name}: coll={row['collision']:.3f} "
...
printf '========== fresh157 triage summary =========='"\n"
cat "$SUMMARY"