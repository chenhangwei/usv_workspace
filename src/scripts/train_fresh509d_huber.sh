...
OUTPUT="${OUTPUT:-/mnt/data/checkpoints/usv_rl/fresh509d_huber.pt}"
CKPT_DIR="${CKPT_DIR:-/mnt/data/checkpoints/usv_rl/fresh509d_checkpoints}"
...
echo "[fresh509b] WARMSTART_FROM=$WARMSTART_FROM"
echo "[fresh509b] OUTPUT=$OUTPUT"
echo "[fresh509b] TOTAL_TIMESTEPS=$TOTAL_TIMESTEPS  ROLLOUT_STEPS=$ROLLOUT_STEPS"
echo "[fresh509b] BASE_ROS_DOMAIN_ID=$BASE_ROS_DOMAIN_ID"
