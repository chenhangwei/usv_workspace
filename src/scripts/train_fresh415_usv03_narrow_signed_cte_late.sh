#!/bin/bash
# fresh415: fresh413 strength with narrowed sign scope.
# Reuses the CTE + one-finished late-lagging recipe, after keeping existing
# finish-heading teachers on their legacy sign.
...
OUTPUT="${OUTPUT:-/mnt/data/checkpoints/usv_rl/fresh415_usv03_narrow_signed_cte_late.pt}" \
CKPT_DIR="${CKPT_DIR:-/mnt/data/checkpoints/usv_rl/fresh415_checkpoints}" \
