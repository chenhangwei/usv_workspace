#!/bin/bash
# fresh307: rear-only overtaking curriculum.
#
...
OUTPUT="${OUTPUT:-/mnt/data/checkpoints/usv_rl/fresh307_rear_only_overtake_from_fresh301.pt}"
CKPT_DIR="${CKPT_DIR:-/mnt/data/checkpoints/usv_rl/fresh307_checkpoints}"
