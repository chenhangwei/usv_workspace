...
WARMSTART_FROM="${WARMSTART_FROM:-/mnt/data/checkpoints/usv_rl/fresh509a3_criticonly.pt}"
OUTPUT="${OUTPUT:-/mnt/data/checkpoints/usv_rl/fresh509b_3usv.pt}"
CKPT_DIR="${CKPT_DIR:-/mnt/data/checkpoints/usv_rl/fresh509b_checkpoints}"
