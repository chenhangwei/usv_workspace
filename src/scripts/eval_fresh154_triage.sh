#!/bin/bash
# One-episode paired triage for fresh154 checkpoints.
...
OUT="${OUT:-/mnt/data/checkpoints/usv_rl/fresh154_eval}"
FINAL_MODEL="${FINAL_MODEL:-/mnt/data/checkpoints/usv_rl/fresh154_cpa_guard_finish_from_fresh153.pt}"
SUMMARY="${SUMMARY:-$OUT/fresh154_triage_summary.tsv}"
EPISODES="${EPISODES:-1}"
STEPS="${STEPS:-420}"
...
candidates=(
  /mnt/data/checkpoints/usv_rl/fresh154_checkpoints/fresh154_cpa_guard_finish_from_fresh153_step_0000288.pt
  /mnt/data/checkpoints/usv_rl/fresh154_checkpoints/fresh154_cpa_guard_finish_from_fresh153_step_0000576.pt
  /mnt/data/checkpoints/usv_rl/fresh154_checkpoints/fresh154_cpa_guard_finish_from_fresh153_step_0000864.pt
  /mnt/data/checkpoints/usv_rl/fresh154_checkpoints/fresh154_cpa_guard_finish_from_fresh153_step_0001152.pt
  "$FINAL_MODEL"
)
...
print(
    f"fresh154-triage {label} {scenario_name}: coll={row['collision']:.3f} "
...
printf '========== fresh154 triage summary =========='"\n"
cat "$SUMMARY"