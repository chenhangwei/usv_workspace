#!/bin/bash
# One-episode paired triage for fresh156 checkpoints.
...
OUT="${OUT:-/mnt/data/checkpoints/usv_rl/fresh156_eval}"
FINAL_MODEL="${FINAL_MODEL:-/mnt/data/checkpoints/usv_rl/fresh156_yield_guard_long_finish_from_fresh153.pt}"
SUMMARY="${SUMMARY:-$OUT/fresh156_triage_summary.tsv}"
EPISODES="${EPISODES:-1}"
STEPS="${STEPS:-420}"
...
candidates=(
  /mnt/data/checkpoints/usv_rl/fresh156_checkpoints/fresh156_yield_guard_long_finish_from_fresh153_step_0000576.pt
  /mnt/data/checkpoints/usv_rl/fresh156_checkpoints/fresh156_yield_guard_long_finish_from_fresh153_step_0001152.pt
  /mnt/data/checkpoints/usv_rl/fresh156_checkpoints/fresh156_yield_guard_long_finish_from_fresh153_step_0001728.pt
  /mnt/data/checkpoints/usv_rl/fresh156_checkpoints/fresh156_yield_guard_long_finish_from_fresh153_step_0002304.pt
  "$FINAL_MODEL"
)
...
print(
    f"fresh156-triage {label} {scenario_name}: coll={row['collision']:.3f} "
...
printf '========== fresh156 triage summary =========='"\n"
cat "$SUMMARY"