...
OUTPUT="${OUTPUT:-/mnt/data/checkpoints/usv_rl/fresh346_role_risk_guard_dense_from_fresh331.pt}"
EPOCHS="${EPOCHS:-52}"
LEARNING_RATE="${LEARNING_RATE:-6.0e-8}"
ANCHOR_WEIGHT="${ANCHOR_WEIGHT:-2200.0}"
ANCHOR_BATCH_SIZE="${ANCHOR_BATCH_SIZE:-1024}"
MAX_GRAD_NORM="${MAX_GRAD_NORM:-0.012}"
MIN_ERROR_NORM="${MIN_ERROR_NORM:-999.0}"
TRAIN_ALL_ACTOR="${TRAIN_ALL_ACTOR:-0}"

TRACE_DIRS="${TRACE_DIRS:-/tmp/fresh331_baseline_seed1456_event_r12_20260518_v1 /tmp/fresh331_baseline_fixed1460_1461_event_r2_20260518_v1 /tmp/fresh345_seed1456_domain220_r12_v1 /tmp/fresh331_seed1456_eventwin_r6_v1}"
...
PRESERVE_DIRS="${PRESERVE_DIRS:-/tmp/fresh331_baseline_fixed1460_1461_event_r2_20260518_v1 /tmp/fresh331_fixed_eventwin_r4_v1 /tmp/fresh331_guard_gate_v1}"
PRESERVE_ACTION_WEIGHT="${PRESERVE_ACTION_WEIGHT:-6.0}"
PRESERVE_MIN_ROUTE_PROGRESS="${PRESERVE_MIN_ROUTE_PROGRESS:-0.68}"
...
RISK_GUARD_WEIGHT="${RISK_GUARD_WEIGHT:-0.95}"
RISK_GUARD_REQUIRE_THREAT="${RISK_GUARD_REQUIRE_THREAT:-0}"
RISK_GUARD_MIN_THREAT="${RISK_GUARD_MIN_THREAT:-0.55}"
RISK_GUARD_MAX_SEPARATION="${RISK_GUARD_MAX_SEPARATION:-1.80}"
RISK_GUARD_MAX_LINEAR="${RISK_GUARD_MAX_LINEAR:-0.10}"
RISK_GUARD_YIELD_MAX_LINEAR="${RISK_GUARD_YIELD_MAX_LINEAR:-0.0}"
RISK_GUARD_STANDON_MAX_LINEAR="${RISK_GUARD_STANDON_MAX_LINEAR:-0.08}"
RISK_GUARD_OMEGA_BLEND="${RISK_GUARD_OMEGA_BLEND:-1.0}"
RISK_GUARD_YIELD_MIN_OMEGA_ABS="${RISK_GUARD_YIELD_MIN_OMEGA_ABS:-0.40}"
RISK_GUARD_STANDON_MIN_OMEGA_ABS="${RISK_GUARD_STANDON_MIN_OMEGA_ABS:-0.12}"
RISK_GUARD_MIN_DISTANCE="${RISK_GUARD_MIN_DISTANCE:-0.40}"
RISK_GUARD_MIN_ROUTE_PROGRESS="${RISK_GUARD_MIN_ROUTE_PROGRESS:-0.18}"
RISK_GUARD_MAX_ROUTE_PROGRESS="${RISK_GUARD_MAX_ROUTE_PROGRESS:-0.78}"
RISK_GUARD_MIN_ABS_CTE="${RISK_GUARD_MIN_ABS_CTE:-0.80}"
