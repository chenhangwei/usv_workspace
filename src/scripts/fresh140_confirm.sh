#!/bin/bash
# fresh140 confirm: paired 3-episode crossing validation against fresh139.
...
LOG="${LOG:-/tmp/fresh140_confirm.log}"
OUT="${OUT:-/mnt/data/checkpoints/usv_rl/fresh140_confirm_eval}"
EPISODES="${EPISODES:-3}"
STEPS="${STEPS:-400}"
...
FRESH140_STEP0288="${FRESH140_STEP0288:-/mnt/data/checkpoints/usv_rl/fresh140_checkpoints/fresh140_guarded_finish_from_fresh139_step0864_step_0000288.pt}"
FRESH140_STEP0576="${FRESH140_STEP0576:-/mnt/data/checkpoints/usv_rl/fresh140_checkpoints/fresh140_guarded_finish_from_fresh139_step0864_step_0000576.pt}"
...

{
  ...
  if [[ "$INCLUDE_BASELINES" == "1" ]]; then
    labels+=("fresh139_step0576" "fresh138_final")
    models+=("$FRESH139_STEP0576" "$FRESH138_FINAL")
  fi
  ...
  summary="$OUT/fresh140_confirm_summary.tsv"
...
PY
  ...
  echo "========== fresh140 confirm summary =========="
  cat "$summary"
  echo "========== fresh140 confirm complete =========="
