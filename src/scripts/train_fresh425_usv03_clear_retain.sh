#!/bin/bash
# fresh425: role-gated progress retention from fresh415.
# fresh423 proved a random clear-ahead cruise teacher can restore progress, but
# also pushed usv_02 into a seed1460 finish-zone collision. This variant applies
# the same teacher only to usv_03 samples.
...
OUTPUT="${OUTPUT:-/mnt/data/checkpoints/usv_rl/fresh425_usv03_clear_retain.pt}" \
CKPT_DIR="${CKPT_DIR:-/mnt/data/checkpoints/usv_rl/fresh425_checkpoints}" \
