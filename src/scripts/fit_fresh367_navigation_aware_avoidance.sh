...
SOURCE_MODEL="${SOURCE_MODEL:-/mnt/data/checkpoints/usv_rl/fresh352_interp_a002_from_fresh331_fresh351.pt}"
OUTPUT="${OUTPUT:-/mnt/data/checkpoints/usv_rl/fresh367_navigation_aware_avoidance_from_fresh352.pt}"
EPOCHS="${EPOCHS:-120}"
LEARNING_RATE="${LEARNING_RATE:-2.0e-4}"
ANCHOR_WEIGHT="${ANCHOR_WEIGHT:-80.0}"
ANCHOR_BATCH_SIZE="${ANCHOR_BATCH_SIZE:-1024}"
MAX_GRAD_NORM="${MAX_GRAD_NORM:-0.35}"
MIN_ERROR_NORM="${MIN_ERROR_NORM:-999.0}"
TRAIN_ALL_ACTOR="${TRAIN_ALL_ACTOR:-1}"

TRACE_DIRS="${TRACE_DIRS:-/tmp/fresh331_baseline_seed1456_event_r12_20260518_v1 /tmp/fresh331_baseline_fixed1460_1461_event_r2_20260518_v1 /tmp/fresh345_seed1456_domain220_r12_v1 /tmp/fresh346_seed1456_domain220_r6_v1}"
ANCHOR_DIRS="${ANCHOR_DIRS:-/tmp/fresh331_baseline_seed1456_event_r12_20260518_v1 /tmp/fresh331_baseline_fixed1460_1461_event_r2_20260518_v1 /tmp/fresh331_baseline_guard1458_1463_event_r3_20260518_v1 /tmp/fresh331_fixed_eventwin_r4_v1}"
PRESERVE_DIRS="${PRESERVE_DIRS:-/tmp/fresh331_baseline_fixed1460_1461_event_r2_20260518_v1 /tmp/fresh331_baseline_guard1458_1463_event_r3_20260518_v1 /tmp/fresh331_fixed_eventwin_r4_v1}"

PRESERVE_ACTION_WEIGHT="${PRESERVE_ACTION_WEIGHT:-16.0}"
...
PRESERVE_MIN_EPISODE_PROGRESS="${PRESERVE_MIN_EPISODE_PROGRESS:-0.02}"

RISK_GUARD_WEIGHT="${RISK_GUARD_WEIGHT:-3.5}"
...
RISK_GUARD_YIELD_MAX_LINEAR="${RISK_GUARD_YIELD_MAX_LINEAR:-0.04}"
RISK_GUARD_STANDON_MAX_LINEAR="${RISK_GUARD_STANDON_MAX_LINEAR:-0.14}"
RISK_GUARD_OMEGA_BLEND="${RISK_GUARD_OMEGA_BLEND:-0.85}"
...
CLEAR_SPEEDUP_WEIGHT="${CLEAR_SPEEDUP_WEIGHT:-1.2}"
LATE_CLEAR_WEIGHT="${LATE_CLEAR_WEIGHT:-1.8}"
