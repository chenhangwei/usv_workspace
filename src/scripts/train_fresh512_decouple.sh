...
WARMSTART_FROM="${WARMSTART_FROM:-/mnt/data/checkpoints/usv_rl/fresh511_consolidate.pt}"
OUTPUT="${OUTPUT:-/mnt/data/checkpoints/usv_rl/fresh512_decouple.pt}"
CKPT_DIR="${CKPT_DIR:-/mnt/data/checkpoints/usv_rl/fresh512_checkpoints}"
...
BASE_ROS_DOMAIN_ID="${BASE_ROS_DOMAIN_ID:-246}"

echo "[fresh512] WARMSTART_FROM=$WARMSTART_FROM"
echo "[fresh512] OUTPUT=$OUTPUT"
echo "[fresh512] TOTAL_TIMESTEPS=$TOTAL_TIMESTEPS  ROLLOUT_STEPS=$ROLLOUT_STEPS"
echo "[fresh512] BASE_ROS_DOMAIN_ID=$BASE_ROS_DOMAIN_ID"
