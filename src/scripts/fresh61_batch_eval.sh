#!/bin/bash
# fresh61 检查点批量评估脚本
# 改进：12 episodes (4/scenario)、275 steps (匹配55s训练超时)、综合评分排名
set -eo pipefail
...
EPISODES=12        # 4 per scenario → 更有统计意义
...
echo "═══════════════════════════════════════════════════"
echo "  fresh61 Batch Evaluation (Composite Scoring)"
...
eval_dir = os.environ.get('EVAL_DIR', '/mnt/data/checkpoints/usv_rl/fresh61_eval')
ranking_path = os.environ.get('RANKING', '/mnt/data/checkpoints/usv_rl/fresh61_ranking.json')
...
echo "═══════════════════════════════════════════════════"
echo "  fresh61 Batch Evaluation Complete"
echo "═══════════════════════════════════════════════════"
