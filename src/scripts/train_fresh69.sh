...
CKPT_DIR="/mnt/data/checkpoints/usv_rl/fresh69_checkpoints"
# Stage A 复用 fresh68 已训练好的（he=0.080 / CTE=0.063 已足够好）
STAGE_A_OUTPUT="/mnt/data/checkpoints/usv_rl/fresh68_stageA.pt"
STAGE_B_OUTPUT="/mnt/data/checkpoints/usv_rl/fresh69_stageB.pt"
STAGE_C_OUTPUT="/mnt/data/checkpoints/usv_rl/fresh69_stageC.pt"
