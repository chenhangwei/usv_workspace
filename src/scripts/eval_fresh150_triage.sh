#!/bin/bash
# One-episode paired triage for fresh150 crossing/random candidates.
...
OUT="${OUT:-/mnt/data/checkpoints/usv_rl/fresh150_eval}"
SUMMARY="${SUMMARY:-$OUT/fresh150_triage_summary.tsv}"
EPISODES="${EPISODES:-1}"
STEPS="${STEPS:-420}"
...
candidates=(
  /mnt/data/checkpoints/usv_rl/fresh150_checkpoints/fresh150_cpa_margin_soft_clear_from_fresh142_step_0000288.pt
  /mnt/data/checkpoints/usv_rl/fresh150_checkpoints/fresh150_cpa_margin_soft_clear_from_fresh142_step_0000480.pt
  /mnt/data/checkpoints/usv_rl/fresh150_cpa_margin_soft_clear_from_fresh142.pt
)
...
print(
    f"fresh150 {label} {scenario_name}: coll={row['collision']:.3f} "
