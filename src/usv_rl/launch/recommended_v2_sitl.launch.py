...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('rl_policy_model', default_value=RECOMMENDED_MODEL_RELATIVE_PATH, description='Default recommended residual policy model path.'),
        DeclareLaunchArgument('rl_policy_kind', default_value='bc', description='Recommended residual policy type.'),
        DeclareLaunchArgument('rl_policy_device', default_value='cpu', description='Inference device for the recommended residual policy.'),
        DeclareLaunchArgument('rl_publish_rate', default_value='10.0', description='Residual action publish rate in Hz.'),
        ...
        DeclareLaunchArgument('rl_inference_delay', default_value='7.0', description='Delay before starting the residual policy node.'),
        recommended_stack,
    ])