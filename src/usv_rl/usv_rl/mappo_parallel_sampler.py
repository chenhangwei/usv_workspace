...
def _build_reward_config(args) -> RewardConfig:
    return RewardConfig(
        ...
        conflict_risk_time_horizon=float(getattr(args, 'conflict_risk_time_horizon', 0.0)),
        conflict_risk_safe_dcpa=float(getattr(args, 'conflict_risk_safe_dcpa', 0.0)),
        ...
        role_giveway_speed=float(getattr(args, 'role_giveway_speed', 0.14)),
        wrong_heading_speed_penalty_weight=float(getattr(args, 'wrong_heading_speed_penalty_weight', 0.0)),
        wrong_heading_speed_threshold_deg=float(getattr(args, 'wrong_heading_speed_threshold_deg', 60.0)),
        ...
        far_side_turn_threshold_deg=float(getattr(args, 'far_side_turn_threshold_deg', 45.0)),
        goal_queue_weight=float(getattr(args, 'goal_queue_weight', 0.0)),
        goal_queue_cluster_radius=float(getattr(args, 'goal_queue_cluster_radius', 1.5)),
        goal_queue_engage_distance=float(getattr(args, 'goal_queue_engage_distance', 4.0)),
        goal_queue_follower_speed=float(getattr(args, 'goal_queue_follower_speed', 0.12)),
        goal_queue_min_separation=float(getattr(args, 'goal_queue_min_separation', 1.2)),
        ...
        crossing_guidance_distance=float(getattr(args, 'crossing_guidance_distance', 0.0)),
