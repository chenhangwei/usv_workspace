...
class MultiAgentEnvConfig:
    ...
    goal_proximity_reward_weight: float = 0.0
    goal_proximity_relief_distance: float = 3.0
    goal_proximity_heading_relief: float = 0.0
    goal_proximity_smoothness_relief: float = 0.0
...
class MultiAgentEnv(gym.Env):
    ...
    def _compute_head_on_guidance_reward(self, observation: AgentLocalObservation) -> float:
