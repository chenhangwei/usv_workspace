...
RECOMMENDED_SMOKE_RELATIVE_PATH = './tmp_rl/recommended_sitl_smoke.json'
RECOMMENDED_SMOKE_LOG_RELATIVE_PATH = './tmp_rl/recommended_sitl_smoke.log'
RECOMMENDED_VALIDATION_BATCH_RELATIVE_PATH = './tmp_rl/post_goal_guard_validate_batch_8_final'
